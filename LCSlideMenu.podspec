#
#  Be sure to run `pod spec lint LCSlideMenu.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "LCSlideMenu"
  s.version      = "0.1.1"
  s.summary      = "A short description of LCSlideMenu."
  ...
  s.source       = { :git => "https://github.com/ChinaHackers/LCSlideMenu.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "LCSlideMenu", "LCSlideMenu/**/*.{h,m,swift}"
  s.exclude_files = "LCSlideMenu/Exclude"
